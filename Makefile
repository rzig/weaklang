CXX=clang++
CXXFLAGS=-std=c++20 -g -fstandalone-debug -Iinclude/ -I/usr/include -I/usr/include/x86_64-linux-gnu -Iinclude/CBLAS/include/ -Linclude/CBLAS/include/ -Linclude/CBLAS/lib/
LFLAGS=-lcblas
