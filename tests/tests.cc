...
TEST_CASE("Complex input", "[lexer]") {
    ...
    REQUIRE(tokens[25].line == 5);
    REQUIRE(tokens[25].col == 11);
    REQUIRE(tokens[50].line == 10);
    REQUIRE(tokens[50].col == 6);
    REQUIRE(tokens[75].line == 12);
    REQUIRE(tokens[75].col == 7);
    REQUIRE(tokens[100].line == 16);
    REQUIRE(tokens[100].col == 13);
    REQUIRE(tokens[125].line == 23);
    REQUIRE(tokens[125].col == 9);
